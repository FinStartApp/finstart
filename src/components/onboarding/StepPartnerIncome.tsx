...
export default function StepPartnerIncome({ onNext, onBack }: Props) {
  ...
  function updateDeduction(field: string, value: number | boolean) {
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-[var(--muted-foreground)] text-base">
          Let's add your partner's income to complete your household picture.
        </p>
      </div>
      ...
      <div className="space-y-3">
        <label className="text-sm font-semibold text-[var(--foreground)] uppercase tracking-wider">
          Does this person receive a bonus?
        </label>
        <div className="grid grid-cols-2 gap-2">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <button
                    key={opt.value}
                    onClick={() => updateEarner(earner.id, { pre_tax_deductions: { ...earner.pre_tax_deductions, retirement_type: opt.value as 'traditional' | 'roth' | 'both' } })}
