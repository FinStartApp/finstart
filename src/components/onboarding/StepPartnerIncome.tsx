        ...
        {earner.deductions_complete && (
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-[var(--muted-foreground)] -mt-1">
                A pension is a retirement benefit paid by their employer
      ...
      {earner.deductions_complete && (
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-[var(--muted-foreground)] mt-1">
              Your partner's current saved balance — not their monthly
              contribution. Used to project your household retirement
              picture accurately.
            </p>
          </div>
